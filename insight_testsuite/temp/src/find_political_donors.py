...
Each Key will contain [transaction_amt, [list_of_transaction_amt_for_specific_cust_in_sorted_manner]]
'''
cust_zip_key = {}
...
buffer_lines = 3 # USed for streaming
input_filename = ""
output_zip_filename = ""
...
def select_few_lines_as_streaming(content):
    ...
    while (end_pointer <= no_of_lines):
        parse_and_verify_content(content[start_pointer:end_pointer])
        start_pointer = end_pointer
        end_pointer = start_pointer + buffer_lines
    parse_and_verify_content(content[start_pointer: no_of_lines])
...
#print(check_filepath_and_create_if_not_exist("/Users/edplus/Google Drive/Workspace/PythonWorkspace/Insight_Data_Donor/output2/medianvals_by_zip.txt"))
